function header(location)
{
    ...
    if (location==="home"){
        ...
        string=
            ...
            string=
			/*'<a class="ui button" href="./'.concat(terminal_loc,'">Terminal</a>&nbsp&nbsp&nbsp*/'<a class="ui button"  target="_blank" href="https://beta.kossiitkgp.org/blog/">Blog</a>'/*)*/;}
            ...
            string=
			/*'<a class="ui inverted secondary button" href="./'.concat(terminal_loc,'">Terminal</a>*/'<a class="ui inverted button"  target="_blank" href="https://beta.kossiitkgp.org/blog/">Blog</a>'/*)*/;}
		else if (location==="term right"){
            string=
			/*'<a class="ui primary button" href="./'.concat(terminal_loc,'">Terminal</a>&nbsp&nbsp&nbsp*/'<a class="ui button"  target="_blank" href="https://beta.kossiitkgp.org/blog/">Blog</a>'/*)*/;}
